...
Instructions for [JetBrains Junie](https://www.jetbrains.com/junie/) when working in this repository.
...
- **Multi-domain changes**: for work spanning C++, CMake, [Qt](https://www.qt.io/)/QML, and platform-specific code, delegate each domain to a focused subagent

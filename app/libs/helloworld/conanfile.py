...
class HelloWorld(ConanFile):
    """
    This is an example of the conanfile.py created with the command
    `tools/run conan new basic -d name=helloworld -d version=0.1`
    and is intended to serve as a template for adding libraries
    to your projects.  It is safe to delete this file and library
    when you are setting your project up.
    """

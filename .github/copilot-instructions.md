...
Instructions for [GitHub Copilot](https://github.com/features/copilot) (coding agent, chat, and code review) when working in this repository.
...
- **Multi-domain changes**: for work spanning C++, CMake, [Qt](https://www.qt.io/)/QML, and platform-specific code, address each domain in a focused pass

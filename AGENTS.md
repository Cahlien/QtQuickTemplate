...
Instructions for AI coding agents (OpenAI Codex, OpenCode, and compatible tools) working in this repository.
...
- **Multi-domain changes**: for work spanning C++, CMake, Qt/QML, and platform-specific code, delegate each domain to a focused subtask

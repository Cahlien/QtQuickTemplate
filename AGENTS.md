...
Instructions for AI coding agents ([OpenAI Codex](https://openai.com/index/openai-codex/), [OpenCode](https://github.com/opencode-ai/opencode), and compatible tools) working in this repository.
